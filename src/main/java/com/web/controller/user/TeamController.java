...
public class TeamController {
    ...
    public String add(@ModelAttribute Teams team, @RequestParam("newAvatar") MultipartFile file,
    ...
    public String xinVaoTeam(@RequestParam Integer team, RedirectAttributes redirectAttributes,
    ...
    public String xoaNhom(@RequestParam Integer team, RedirectAttributes redirectAttributes,
            HttpServletRequest request) {
    ...
    public String duyetThanhVien(@RequestParam Integer id, @RequestParam Integer team, Model model,
            RedirectAttributes redirectAttributes) {
        Teams teams = teamdao.findById(team).get();
    ...
    public String xoaThanhVien(@RequestParam Integer id, RedirectAttributes redirectAttributes,
            HttpServletRequest request) {
    ...
    public String updateDescription(@RequestParam Integer detailId, @RequestParam String description,
    ...
    public String phongDoiTruong(@RequestParam Integer team, @RequestParam Long userId,
            RedirectAttributes redirectAttributes, HttpServletRequest request) {
    ...
    public String teamDetailExit(@PathVariable Integer teamId, RedirectAttributes redirectAttributes,
            HttpServletRequest request) {
